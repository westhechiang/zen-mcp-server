...
class XAIModelProvider(OpenAICompatibleProvider):
    ...
    def generate_content(
        ...
        **kwargs,
        ...
        """Generate content using X.AI API with proper model name resolution and timeout enforcement."""
    ...
    def _generate_with_timeout(
        ...
        **kwargs,
        ...
        logger.debug(f"X.AI: Enforcing {timeout}s timeout for {model_name} using ThreadPoolExecutor")
        
        def _generate():
            # Call parent implementation with resolved model name
            return super(XAIModelProvider, self).generate_content(
                prompt=prompt,
        ...
        with ThreadPoolExecutor(max_workers=1) as executor:
            ...
            try:
                ...
                future.cancel()
                error_msg = (
                    f"X.AI API call timed out after {timeout}s for model {model_name}. "
                ...
                logger.error(f"X.AI API error for {model_name}: {str(e)}")
                raise
